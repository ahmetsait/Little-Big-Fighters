module lbf.graphics.opengl.gl.types;
...
extern(System)
{
	alias GLDEBUGPROC = void function(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, in GLchar* message, GLvoid* userParam);
	alias GLDEBUGPROCARB = GLDEBUGPROC;
	alias GLDEBUGPROCKHR = GLDEBUGPROC;
	alias GLDEBUGPROCAMD = void function(GLuint id, GLenum category, GLenum severity, GLsizei length, in GLchar* message, GLvoid* userParam);
}
